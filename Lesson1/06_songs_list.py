...
dil_halo= violator_songs_list[3][1]
dil_enjoy= violator_songs_list[5][1]
dil_clean= violator_songs_list[-1][1]
print('Трипесни звучат',dil_clean+dil_halo+dil_enjoy,'минут')
